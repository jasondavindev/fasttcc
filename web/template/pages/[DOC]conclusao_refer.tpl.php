					...
					<div class="content-padding">
						<div class="section-page">
							...
							<div class="section" style="width: 70%;">
								<div class="section-title">{#TITULO_OBJETIVO}</div>
								
								<div class="section-content">
									<form name="frm-conclusao" id="frm-conclusao" class="form-style">
										<input type="hidden" value="{#ID_OBJ}" name="obj"/>
										<textarea name="conclusao" class="textarea" placeholder="">{#CONTEUDO}</textarea>
										<div class="buttons-align">
											<button class="button-flat" id="salva-conclusao">Salvar</button>
										</div>
									</form>
								</div>
							</div>
